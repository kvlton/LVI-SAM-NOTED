...
void process()
{
    ...
    while (ros::ok())
    {
        sensor_msgs::ImageConstPtr image_msg = NULL;      // 图像
        sensor_msgs::PointCloudConstPtr point_msg = NULL; // 特征
        nav_msgs::Odometry::ConstPtr pose_msg = NULL;     // 位姿
